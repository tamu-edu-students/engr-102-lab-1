...
2.	Calculate the wavelength of x-rays scattering from a crystal lattice with a distance between crystal layers of 0.030 nm, scattering angle of 35 degrees, and first order diffraction. **Bragg’s Law** describes the scattering of waves from a crystal using the equation<br/>
$$nλ=2d\sin⁡θ$$<br/>
...
Calculate the change of velocity of a fighter jet for an initial mass of 11000 kg, final mass of 8300 kg, and exhaust velocity of 2030 m/s.

Example output:
```
Reynolds number is 5250.0
Wavelength is 0.03441458618106276 nm
Production rate is 2.8969356500320727 barrels/day
Change of velocity is 571.7287087315112 m/s
```
